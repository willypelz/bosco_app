...
{{--                    </li>--}}
            ...
            <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="chat_content">
                                    <div class="chat_heading clearfix">
                                        ...
                                        Create Post: <span class="act_users"></span>
                                    </div>
                                    <br>

                                    <form method = "post" id="new_message_form" class="form-horizontal dropzone dz-clickable"
                                          enctype="multipart/form-data" id="my-dropzone" action="{{route('createpost')}}">
                                        @csrf
                                        <div class="form-group">
                                            <label for="mail_sender" class="col-lg-2 control-label">Category</label>
                                            <div class="col-lg-8">
                                                <select id="mail_sender" name="category" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <label for="mail_subject" class="col-lg-2 control-label">Title</label>
                                            <div class="col-lg-8">
                ...
                <path class="circ path" style="fill:none;stroke:#77d27b;stroke-width:3;stroke-linejoin:round;stroke-miterlimit:10;" d="M30.5,6.5L30.5,6.5c6.6,6.6,6.6,17.4,0,24l0,0c-6.6,6.6-17.4,6.6-24,0l0,0c-6.6-6.6-6.6-17.4,0-24l0,0C13.1-0.2,23.9-0.2,30.5,6.5z"></path>
                                        ...
                                        <div class="form-group">
                                            <label for="mail_message" class="col-lg-2 control-label">Body</label>
                                            <div class="col-lg-8">
                                                <textarea name="body" id="" cols="10" rows="16" class="form-control auto_expand"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
